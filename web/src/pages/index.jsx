    ...
    <div className="Page">
      ...
      <div className="main-content">
        ...
        <section id="mission">
          ...
          <ul>
            <p>FoundMemories started with a simple but urgent truth: time doesn’t wait — and every untold story is a legacy that could disappear.
...
But we’re not just recording the past. We’re reconnecting generations. We’re giving elders a voice, and giving young people a way to lead with empathy and purpose.</p>
            <p>It all began with one conversation — a quiet, unexpected moment between a grandson and his grandfather. That single memory became our first story. And it reminded us of something deeply simple: listening can be transformative.
Since then, we’ve grown into a team of young interviewers, writers, and animators, working together to capture the voices and wisdom of those who helped shape our communities.
